  ...
  return (
    <div className="fixed right-5 bottom-5 z-50 flex flex-col items-end gap-3">
      ...
      <button
        ...
        aria-label="Scroll to top"
        title="Back to top"
        className="bg-white/95 hover:bg-white rounded-full w-14 h-14 flex items-center justify-center text-[var(--cf-dark-green)] shadow-lg"
      >
        <svg xmlns="http://www.w3.org/2000/svg" className="w-7 h-7" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
          <path fillRule="evenodd" d="M3.707 10.707a1 1 0 01-1.414-1.414l7-7a1 1 0 011.414 0l7 7a1 1 0 01-1.414 1.414L11 5.414V18a1 1 0 11-2 0V5.414L3.707 10.707z" clipRule="evenodd" />
        </svg>
      </button>
