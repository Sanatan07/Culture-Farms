...
// //                 {product.availability === 'Available Year-Round' && (
// //                   <p className="text-2xl font-bold text-cf-mid mb-2">₹269</p>
// //                 )}
...
//                 {product.availability === 'Available Year-Round' ? (
//                   <>
//                     <p className="text-2xl font-bold text-cf-mid mb-4">₹269</p>
//                     <button 
//                       onClick={() => window.open('https://culturefarms.shop/', '_blank')}
//                       className="w-full badge-year px-4 py-3 rounded-full text-sm font-medium hover:opacity-90 transition-opacity"
//                     >
//                       Buy Now
//                     </button>
//                   </>
